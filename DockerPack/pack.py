...
def create_dockerfile(local_dir_name, work_dir_name, run_cmd):
...
if __name__ == "__main__":
    ...
    create_dockerfile(local_dir_name=args.local, work_dir_name=args.work, run_cmd=str(args.command))
    build(tag=args.tag)
    if args.repo:
